    ...
    <div className="space-y-6 max-w-2xl">
      ...
      <form onSubmit={handleSubmit} className="bg-[#141414] border border-admin-border/50 rounded-xl p-6 space-y-4">
        <div className="space-y-1.5">
          ...
          <input name="question" required className="w-full bg-[#0a0a0a] border border-admin-border/50 rounded-lg px-3 py-2 text-sm text-admin-text-primary focus:outline-none focus:border-admin-accent" />
        </div>
        <div className="space-y-1.5">
          <label className="text-sm text-admin-text-secondary">Answer *</label>
          <textarea name="answer" rows={4} required className="w-full bg-[#0a0a0a] border border-admin-border/50 rounded-lg px-3 py-2 text-sm text-admin-text-primary focus:outline-none focus:border-admin-accent" />
        </div>
        <div className="grid grid-cols-2 gap-4">
          <div className="space-y-1.5">
            <label className="text-sm text-admin-text-secondary">Category</label>
            <input name="category" className="w-full bg-[#0a0a0a] border border-admin-border/50 rounded-lg px-3 py-2 text-sm text-admin-text-primary focus:outline-none focus:border-admin-accent" />
          </div>
          <div className="space-y-1.5">
