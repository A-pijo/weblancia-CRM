...
export const metadata: Metadata = {
  ...
  keywords: ["Weblancia", "cookies", "RGPD", "consentement", "traceurs"],
  ...
  twitter: { card: "summary_large_image", site: "@weblancia", creator: "@weblancia", title: "Gestion des Cookies | Weblancia", description: "Politique de gestion des cookies de Weblancia.", images: ["/images/og/og.svg"] },
...
export default function CookiesPage() {
  return (
    <>
      <WebPageJsonLd name="Gestion des Cookies | Weblancia" description="Consultez la politique de gestion des cookies de Weblancia." url={`${siteConfig.url}/legal/cookies`} />
      <SectionWrapper>
        <Container>
        <AnimatedReveal>
          <div className="max-w-3xl mx-auto">
            ...
            <h2 className="text-h2 font-semibold mb-4">1. Qu&apos;est-ce qu&apos;un cookie ?</h2>
            ...
            <h2 className="text-h2 font-semibold mb-4">2. Types de cookies utilisés</h2>
            ...
            <h2 className="text-h2 font-semibold mb-4">4. Gestion des cookies</h2>
            <p className="text-body text-text-secondary mb-6 leading-relaxed">
            ...
            <h2 className="text-h2 font-semibold mb-4">5. Durée de conservation</h2>
            <p className="text-body text-text-secondary mb-6 leading-relaxed">
            ...
            <h2 className="text-h2 font-semibold mb-4">6. Contact</h2>
