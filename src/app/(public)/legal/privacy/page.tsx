      ...
      <Container>
        <AnimatedReveal>
          <div className="max-w-3xl mx-auto">
            ...
            <h2 className="text-h3 font-semibold mb-4">1. Collecte des données</h2>
            ...
            <h2 className="text-h3 font-semibold mb-4">2. Finalités du traitement</h2>
            <p className="text-body text-text-secondary mb-6 leading-relaxed">
            ...
            <h2 className="text-h3 font-semibold mb-4">4. Durée de conservation</h2>
            <p className="text-body text-text-secondary mb-6 leading-relaxed">
            ...
            <h2 className="text-h3 font-semibold mb-4">5. Destinataires des données</h2>
            <p className="text-body text-text-secondary mb-6 leading-relaxed">
            ...
            <h2 className="text-h3 font-semibold mb-4">6. Sécurité</h2>
            <p className="text-body text-text-secondary mb-6 leading-relaxed">
              Nous mettons en œuvre des mesures techniques et organisationnelles appropriées 
              pour protéger vos données contre tout accès non autorisé, altération ou divulgation.
            </p>

            <h2 className="text-h3 font-semibold mb-4">7. Vos droits</h2>
            <p className="text-body text-text-secondary mb-6 leading-relaxed">
            ...
            <h2 className="text-h3 font-semibold mb-4">8. Contact</h2>
