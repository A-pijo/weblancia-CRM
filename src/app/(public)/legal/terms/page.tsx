      ...
      <Container>
        <AnimatedReveal>
          <div className="max-w-3xl mx-auto">
            ...
            <h2 className="text-h3 font-semibold mb-4">1. Objet</h2>
            ...
            <h2 className="text-h3 font-semibold mb-4">2. Services</h2>
            <p className="text-body text-text-secondary mb-6 leading-relaxed">
            ...
            <h2 className="text-h3 font-semibold mb-4">3. Propriété intellectuelle</h2>
            <p className="text-body text-text-secondary mb-6 leading-relaxed">
            ...
            <h2 className="text-h3 font-semibold mb-4">4. Devis et facturation</h2>
            <p className="text-body text-text-secondary mb-6 leading-relaxed">
            ...
            <h2 className="text-h3 font-semibold mb-4">5. Confidentialité</h2>
            <p className="text-body text-text-secondary mb-6 leading-relaxed">
            ...
            <h2 className="text-h3 font-semibold mb-4">6. Responsabilité</h2>
            <p className="text-body text-text-secondary mb-6 leading-relaxed">
            ...
            <h2 className="text-h3 font-semibold mb-4">7. Droit applicable</h2>
